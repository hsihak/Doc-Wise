    ...
    const handleSubmit = async (e) => {
      ...
      setTimeout(async () => {
        ...
        try {
          ...
          const response = await axios.post('http://127.0.0.1:5000/phase-two/upload', formData);
      ...
      {canPerformAction && (
        <>
          <Typography variant='h6'>
            Set your preferred threshold in the form of an integer in the box below: <span className='text-red-500'>*</span>
          </Typography>
          <input
            type='number'
            placeholder='ex. 5'
            className={`border rounded-lg px-4 py-2 ${!isValid ? 'border-red-500' : 'border-[#707070]'}`}
            value={threshold}
          ...
          <div className='grid grid-cols-3 mt-5 w-2/4'>
            ...
            <div className=' col-span-1'>
              <FileUploadForm
                ...
                actionType="highlight differences"
              />
            </div>
          </div>
        )}
